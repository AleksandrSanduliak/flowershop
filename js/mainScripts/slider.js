// 'use strict';
import { imgList } from "./flowerCard.js"
...
const flowercardLi = (imgList) =>
  `<li ${imgList.current} class="flowerCard__li"><img src="${imgList.link}" alt="Фото роз" class="flowerCard__img"></li>`
